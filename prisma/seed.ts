...
async function main() {
  ...
  console.log(`🎫 Scheduled ${createdShows.length} shows and populated show seat inventories.`);
  ...
  console.log('📋 Created demo waitlist entry.');
